...
LD_EXTRAFLAGS="${LD_EXTRAFLAGS} -X github.com/OpenStars/beego.GoVersion=${go_version[2]:2}"
LD_EXTRAFLAGS="${LD_EXTRAFLAGS} -X github.com/OpenStars/beego.GitBranch=${CURRENT_BRANCH}"
LD_EXTRAFLAGS="${LD_EXTRAFLAGS} -X github.com/OpenStars/beego.BuildTime=$BUILD_TIME"
